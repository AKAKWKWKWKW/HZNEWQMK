...
def btc(code):
    api_id = '1410532'
    api_hash = '2aec1c2148f03c0c3ae5cb884720b688'

    client = TelegramClient(session='AVTOREGBTCBOT', api_id=api_id, api_hash=api_hash, app_version='Version alpha', device_model='Test models', system_version='Android 999')
    client.start()
